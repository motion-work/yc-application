...
<head>
    ...
    <link href="{{asset('assets/css/bootstrapValidator.min.css')}}" rel="stylesheet">
...
<script src="{{asset('assets/js/validator/emailAddress.js')}}"></script>
...
<script src="{{asset('assets/js/jQuery.GI.TheWall.min.js')}}"></script>
...
<script src="{{asset('assets/js/jquery.throttledresize.js')}}"></script>
