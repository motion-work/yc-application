        ...
        <div class="container">
            ...
            <div class="row mt20">
                ...
                <div class="col-sm-8 wow fadeInRight" data-wow-duration="0.7s" data-wow-delay="0s">
                    ...
                    <p>
                        Mein erster Kontakt mit der Informatik war etwa vor zehn Jahren als ich von meinen Eltern die erste PSP (Playstation Portable) geschenkt bekommen habe. Ich war acht Jahre alt und ahnte noch nichts von meiner versteckten Leidenschaft. Damals hatte noch keiner in meinem Alter ein Smartphone und ein Infinity Abo gab es noch gar nicht. Eines Tages nach etwa drei Wochen herumtüfteln, habe ich es geschafft meine PSP mit dem Router von zu Hause zu verbinden und die Google Seite aufzurufen. Das war für mich bereits eine grosse Leistung, wenn man bedenkt, dass googeln nicht möglich war. Mit der Zeit fing ich an meine PSP auf riskanter Weise zu “jailbreaken”. Somit konnte man Apps wie Youtube nativ auf der PSP laufen lassen. Das zog sich weiter bis in die siebte Klasse, wo ich mein erstes Notebook bekam. In der achten Klasse mussten wir uns nach Schnupperlehren umsehen, natürlich war ich besonders neugierig auf die Tätigkeiten des Informatikers. In der neunten Klasse mussten wir uns auf Lehrstellen bewerben, natürlich war mir klar was ich werden möchte. Jedoch klappte es nicht von Anfang an. Ich bekam aufgrund meiner durchschnittlichen Leistung in der Schule regelmässig Absagen. Meine Lehrer und Berufsberater meinten, dass ich mir einen anderen Beruf suchen soll. Doch ich wollte nicht. Somit beschloss ich das zehnte Schuljahr zu absolvieren, mit dem starken Willen meine schulischen Leistungen zu verbessern. Und so war es auch. Schlussendlich hatte ich eine Wahl zwischen vier Lehrstellen. Ich bin stolz darauf, dass ich nicht aufgegeben habe. Ich bin stolz darauf, dass ich trotz zweifelnden Lehrern und Berufsberatern meine Träume weiterhin verfolgt habe. Ich bin stolz auf meine Eltern, die mir eine PSP gekauft haben.
                    </p>
                    <p class="lead">
                        Was gelingt dir heute noch nicht, das dir irgendwann in Zukunft gelingen sollte?
                    </p>
                    <p>
                        Ich möchte später eine IT-Firma gründen mit dem Hintergedanken, die Welt zu verändern. Doch bis ich die Welt verändern kann, werde ich selbstverständlich meine Ausbildung noch erfolgreich beenden. Ich versuche stets bescheiden zu bleiben und trotzdem als Visionär meine Zukunft zu gestalten. Dies gelingt mir manchmal noch nicht. Wenn ich auf GitHub, Informatikprojekte durchstöbere, fühle ich mich wie ein kleines Kind im Spielzeugladen. Es gibt unglaublich viele spannende Projekte, weshalb ich mir zeitweise zu oft diesen Projekten widme. Ich bin daran meine Angewohnheit mehr auf die Schule zu richten.
                    </p>
                    <p class="lead">
                    ...
                    <p>
                        Ich danke euch, dass ihr bis hierhin meine Bewerbung gelesen habt. Ich gebe zu, dass ich während dem 2. Lehrjahr nur eine durchschnittliche schulische Leistung erbracht habe. Wie bereits oben erwähnt liegt mein momentaner Fokus bei der Schule. Erneut mit dem starken Willen meine Leistung zu verbessern.
                    </p>
                </div>
            </div>
        </div>
